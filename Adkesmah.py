...
#     st_lottie(animation, speed=1, width=700, height=700, key="anima")
    ...
    st.write("Membuat perubahan yang lebih baik dimulai dari menyuarakan masalah. Dengan Gantari Help, Anda memiliki kesempatan untuk mengutarakan segala masalah dan keluhan yang Anda alami Semasa PKU. Kami menjamin privasi dan keamanan informasi yang Anda berikan, serta memberikan solusi yang tepat dan efektif untuk setiap masalah yang dihadapi.")
